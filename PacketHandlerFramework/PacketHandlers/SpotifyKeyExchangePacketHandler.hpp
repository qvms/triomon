...
#include "../PacketParser/Packets/SpotifyKeyExchangePacket.hpp"
...
class SpotifyKeyExchangePacketHandler : public AbstractPacketHandler, public PacketParser::PacketHandlers::ITcpSessionPacketHandler {
public:
    explicit SpotifyKeyExchangePacketHandler(PacketHandler* mainPacketHandler);

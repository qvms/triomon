...
class Icmpv6Packet : public AbstractPacket, public virtual ITransportLayerPacket {
private:
    uint8_t m_type;
    uint8_t m_code;
    uint16_t m_checksum;
...
public:
    ...
    Icmpv6Packet(const Frame* parentFrame, int packetStartIndex, int packetEndIndex);
    ...
    RFC1700Protocol TransportProtocol() const override { return RFC1700Protocol::ICMPv6; }
